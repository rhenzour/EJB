...
@NamedQueries({
    ...
    @NamedQuery(name = "Compte.findByNumero", 
                query = "SELECT c FROM Compte c WHERE c.numero = :numero"),
    @NamedQuery(name = "Compte.findByProprietaire", 
                query = "SELECT c FROM Compte c WHERE c.proprietaire = :proprietaire"),
    @NamedQuery(name = "Compte.findBySolde", 

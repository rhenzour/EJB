...
//asadmin create-jdbc-connection-pool --datasourceclassname com.mysql.jdbc.jdbc2.optional.MysqlDataSource  --property user=root:password=password:DatabaseName=VouchersDB:ServerName=localhost:port=3306 MyVouchersDB-pool
@Stateful

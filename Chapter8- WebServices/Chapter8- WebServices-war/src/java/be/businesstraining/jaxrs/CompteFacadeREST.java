...
package be.businesstraining.jaxrs;
 ...
 */
@Stateless
@Path("be.businesstraining.entities.compte")
public class CompteFacadeREST extends AbstractFacade<Compte> {
    @PersistenceContext(unitName = "Chapter8-_WebServices-warPU")
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") String id, Compte entity) {
        super.edit(entity);
    }
    ...
    public Compte find(@PathParam("id") String id) {
